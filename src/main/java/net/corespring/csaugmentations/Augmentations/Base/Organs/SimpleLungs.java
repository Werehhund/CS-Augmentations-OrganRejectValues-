...
public abstract class SimpleLungs extends SimpleOrgan implements IAirTime {
    private final int pAirTime;

    public SimpleLungs(IOrganTiers pTier, Properties pProperties) {
        super(pTier, pProperties);
        this.pAirTime = getIntAttribute(CSOrganTiers.Attribute.AIR_TIME);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if(Screen.hasShiftDown()) {
            ...
            pTooltipComponents.add(Component.translatable("tooltip.csaugmentations.lung_desc").withStyle(ChatFormatting.GOLD));
        } else {
