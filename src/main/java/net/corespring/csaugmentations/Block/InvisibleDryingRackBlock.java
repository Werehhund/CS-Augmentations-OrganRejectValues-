...
public class InvisibleDryingRackBlock extends Block {
    public InvisibleDryingRackBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void playerWillDestroy(Level pLevel, BlockPos pPos, BlockState pState, Player pPlayer) {
        ...
        if (fabPos != null) {
            ...
            if (fabState.getBlock() instanceof RefinedDryingRackBlock) {
    ...
    private BlockPos findBlock(Level pLevel, BlockPos pPos) {
        for (Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (adjacentState.getBlock() instanceof RefinedDryingRackBlock) {
                return adjacentPos;
            }
        }
        return null;
