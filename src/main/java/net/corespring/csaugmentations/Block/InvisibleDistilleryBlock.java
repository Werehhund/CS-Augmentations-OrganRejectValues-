...
public class InvisibleDistilleryBlock extends Block {
    public InvisibleDistilleryBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void playerWillDestroy(Level pLevel, BlockPos pPos, BlockState pState, Player pPlayer) {
        ...
        if (fabPos != null) {
            ...
            if (fabState.getBlock() instanceof DistilleryBlock) {
    ...
    private BlockPos findBlock(Level pLevel, BlockPos pPos) {
        for (Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (adjacentState.getBlock() instanceof DistilleryBlock) {
                return adjacentPos;
            }
        }
        return null;
